 ...
 * @Author: bamboo
 * @Description:
 * @Date: 2023-03-29 18:52:24
 * @LastEditors: Do not Edit
 * @LastEditTime: 2023-04-12 15:27:02
 */
'use strict';
...
inquirer
  ...
  .then(res => {
    const message = `当前选中page: ${res.buildLists.join(',')}`;
...
async function build(buildList) {
  ...
  // await execa("webpack", ["server", "--config", "./config/webpack-config/webpack.prod.js"], {
  //   stdio: "inherit",
  //   env: {
  //     pages: strLists,
  //     NODE_ENV: "production"
